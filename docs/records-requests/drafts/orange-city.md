# Records request — City of Orange City

| | |
|---|---|
| **To** | TBD — find the Building Division / records contact at https://www.orangecityfl.gov/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Orange City permit records) works fine.
