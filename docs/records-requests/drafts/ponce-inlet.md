# Records request — Town of Ponce Inlet

| | |
|---|---|
| **To** | TBD — find the Building Department / records contact at https://www.ponce-inlet.org/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Town of Ponce Inlet permit records) works fine.
