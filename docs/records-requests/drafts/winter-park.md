# Records request — City of Winter Park

| | |
|---|---|
| **To** | TBD — find the Building & Permitting Services / records contact at https://cityofwinterpark.org/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Winter Park permit records) works fine.
