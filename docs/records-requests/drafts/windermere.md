# Records request — Town of Windermere

| | |
|---|---|
| **To** | TBD — find the Building Department / Town Clerk / records contact at https://town.windermere.fl.us/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Town of Windermere permit records) works fine.
