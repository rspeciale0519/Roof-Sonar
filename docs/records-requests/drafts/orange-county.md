# Records request — Orange County (unincorporated)

| | |
|---|---|
| **To** | TBD — find the Division of Building Safety (Fast Track) / records contact at https://www.orangecountyfl.net/PermitsLicenses/ |
| **Department** | Division of Building Safety (Fast Track) |
| **County** | Orange |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Orange County (unincorporated) permit records) works fine.
