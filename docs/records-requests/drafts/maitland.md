# Records request — City of Maitland

| | |
|---|---|
| **To** | TBD — find the Community Development — Building / records contact at https://www.itsmymaitland.com/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Maitland permit records) works fine.
