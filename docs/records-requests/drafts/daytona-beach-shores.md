# Records request — City of Daytona Beach Shores

| | |
|---|---|
| **To** | TBD — find the Building Department / records contact at https://www.dbshores.org/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Daytona Beach Shores permit records) works fine.
