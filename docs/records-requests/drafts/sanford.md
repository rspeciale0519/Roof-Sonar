# Records request — City of Sanford

| | |
|---|---|
| **To** | TBD — find the Building & Fire Prevention Division / records contact at https://www.sanfordfl.gov/ |
| **Department** | Building & Fire Prevention Division |
| **County** | Seminole |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Sanford permit records) works fine.
