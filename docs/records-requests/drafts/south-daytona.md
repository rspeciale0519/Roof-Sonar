# Records request — City of South Daytona

| | |
|---|---|
| **To** | TBD — find the Building Department / records contact at https://www.southdaytona.org/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of South Daytona permit records) works fine.
