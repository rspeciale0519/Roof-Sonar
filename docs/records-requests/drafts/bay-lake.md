# Records request — City of Bay Lake

| | |
|---|---|
| **To** | TBD — find the City Administration (Disney; minimal residential) / records contact at https://www.cityofbaylakefl.gov/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Bay Lake permit records) works fine.
