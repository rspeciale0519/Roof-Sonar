# Records request — Town of Oakland

| | |
|---|---|
| **To** | TBD — find the Building Services / records contact at https://www.oaklandfl.gov/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Town of Oakland permit records) works fine.
