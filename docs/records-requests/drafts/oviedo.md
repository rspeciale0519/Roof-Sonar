# Records request — City of Oviedo

| | |
|---|---|
| **To** | TBD — find the Building Division / records contact at https://www.cityofoviedo.net/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Oviedo permit records) works fine.
