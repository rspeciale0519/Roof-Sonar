# Records request — City of Orlando

| | |
|---|---|
| **To** | TBD — find the Permitting Services (records request for fields not in open data) / records contact at https://www.orlando.gov/ |
| **Department** | Permitting Services (records request for fields not in open data) |
| **County** | Orange |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Orlando permit records) works fine.
