# Records request — City of Edgewood

| | |
|---|---|
| **To** | TBD — find the Building / City Clerk / records contact at https://edgewood-fl.gov/ |
| **Department** | Building / City Clerk |
| **County** | Orange |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Edgewood permit records) works fine.
