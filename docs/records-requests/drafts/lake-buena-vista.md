# Records request — City of Lake Buena Vista

| | |
|---|---|
| **To** | TBD — find the City Administration (Disney; minimal residential) / records contact at https://www.cityoflakebuenavistafl.gov/ |
| **Department** | City Administration (Disney; minimal residential) |
| **County** | Orange |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Lake Buena Vista permit records) works fine.
