# Records request — Town of Pierson

| | |
|---|---|
| **To** | TBD — find the Town Hall / Building / records contact at https://www.piersonfl.org/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Town of Pierson permit records) works fine.
