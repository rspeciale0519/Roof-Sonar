# Records request — Seminole County (unincorporated)

| | |
|---|---|
| **To** | TBD — find the Building Division / records contact at https://www.seminolecountyfl.gov/departments-services/development-services/building/ |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (Seminole County (unincorporated) permit records) works fine.
