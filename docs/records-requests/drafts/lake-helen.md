# Records request — City of Lake Helen

| | |
|---|---|
| **To** | TBD — find the Building Department / City Clerk / records contact at https://www.lakehelen.com/ |
| **Department** | Building Department / City Clerk |
| **County** | Volusia |
...
Please advise of any fees before fulfilling. If any portion of this request is unclear or would be easier to fulfill in a different format, I'm happy to adjust — a raw export from your permitting system (City of Lake Helen permit records) works fine.
